...
def gif(h,n, escala = 1, index = 1):
    index = index - 1 # Define qual frequência será usada, indo de 1 até 5, sendo 1 a frequência de menor valor
...
def main():
    ...
    if tarefa == '1':
        ...
        while printar != '1' and printar != '2':
            print("Escolha uma opção válida")
            printar = input('Você quer ver as 5 menores frequências naturais do sistema [1-sim; 2-não]: ') 
        ter_gif = input('Você quer ver uma animação da vibração [1-sim; 2-não]: ') 
        while printar != '1' and printar != '2':
            print("Escolha uma opção válida")
            ter_gif = input('Você quer ver uma animação da vibração [1-sim; 2-não: ') 
    a,b,H = Householder(A)
    ...
    if tarefa == '2':
        ...
        if ter_gif == '1':
            ...
            n = int(input('Escolha o número de quadros'))
            escala1 = float(input('Defina a escala das deformações: '))
            index1 = int(input('Escolha a frequência [1-menor freq. até 5-maior freq.]: '))
